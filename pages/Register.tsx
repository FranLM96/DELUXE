        ...
        <div className="min-h-screen text-white flex items-center justify-center py-20 px-4">
            <div className="w-full max-w-md">
                 <div className="bg-slate-900 rounded-[2.5rem] p-8 sm:p-12 border border-white/10 shadow-2xl relative overflow-hidden">
                    ...
                    <h1 className="text-4xl font-black text-center mb-10 uppercase tracking-tighter">{t('auth.register_title')}</h1>
                    
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-cyan-400 mb-2 ml-1">{t('auth.name')}</label>
                            <input
                                type="text"
                                value={name}
                        ...
                        <div>
                            <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-cyan-400 mb-2 ml-1">{t('auth.password')}</label>
                            <input
                                type="password"
                                value={password}
                        ...
                        <Button type="submit" className="w-full py-4 rounded-2xl">{t('auth.register_btn')}</Button>
                    </form>
